            ...
            item {
                when (selectedCategory) {
                    ...
                    SettingsCategory.Terminal -> TerminalSettings(
                        ...
                        onApplyTerminalThemeColorsChanged = onApplyTerminalThemeColorsChanged,
                        currentTerminalFontSize = currentTerminalFontSize,
                        onTerminalFontSizeChanged = onTerminalFontSizeChanged,
                        currentTerminalColumns = currentTerminalColumns,
                        onTerminalColumnsChanged = onTerminalColumnsChanged,
